...
async function runInscricao(overrides = {}) {
  ...
  console.log(`pausa ${Math.round(PASSO_MS / 1000)}s após criação do lead`);
  await sleep(PASSO_MS);
  ...
  console.log(`pausa ${Math.round(PASSO_MS / 1000)}s após atualização do lead`);
  await sleep(PASSO_MS);
  ...
  console.log(`pausa ${Math.round(PASSO_MS / 1000)}s após addToCart`);
  await sleep(PASSO_MS);
  ...
  console.log(`pausa ${Math.round(PASSO_MS / 1000)}s após transaction`);
  await sleep(PASSO_MS);
